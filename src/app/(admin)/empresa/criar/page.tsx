...
export default function CriarEmpresa() {
  ...
  async function criarEmpresa(data: EmpresaForm) {
    ...
    console.log('Dados enviados:', novaEmpresa)
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-4">
            <div>
              ...
              <input 
                ...
                type="text" 
                id="nome" 
                className={`border rounded-md p-3 w-full focus:outline-none focus:ring-2 shadow-sm ${
                  errors.nome ? 'border-red-500 focus:ring-red-400' : 'border-gray-300 focus:ring-yellow-400'
                }`} 
            ...
            <div>
              ...
              <input 
                ...
                id="cnpj" 
                className={`border rounded-md p-3 w-full focus:outline-none focus:ring-2 shadow-sm ${
                  errors.cnpj ? 'border-red-500 focus:ring-red-400' : 'border-gray-300 focus:ring-yellow-400'
                }`} 
            ...
            <div>
              ...
              <input 
                ...
                id="senha" 
                className={`border rounded-md p-3 w-full focus:outline-none focus:ring-2 shadow-sm ${
                  errors.senha ? 'border-red-500 focus:ring-red-400' : 'border-gray-300 focus:ring-yellow-400'
                }`} 
            ...
            <div>
              ...
              <input 
                ...
                id="atuacao" 
                className={`border rounded-md p-3 w-full focus:outline-none focus:ring-2 shadow-sm ${
                  errors.atuacao ? 'border-red-500 focus:ring-red-400' : 'border-gray-300 focus:ring-yellow-400'
                }`} 
        ...
        <fieldset className="border border-gray-300 rounded-md p-4">
          ...
          <div className="mt-4">
            ...
            <input 
              ...
              id="logotipo" 
              className={`border rounded-md p-3 w-full focus:outline-none focus:ring-2 shadow-sm ${
                errors.logotipo ? 'border-red-500 focus:ring-red-400' : 'border-gray-300 focus:ring-yellow-400'
              }`} 
