...
const Home: React.FC = () => {
  ...
  useEffect(() => {
    ...
    fetchDados('/api/empresas/atuacao', setDadosEmpresas, 'Área de Atuação', setCoresEmpresas)
    fetchDados('/api/contratados/atuacao', setDadosContratados, 'Área de Atuação', setCoresContratados)
    getDadosGerais()
    setFocus('nome')
  }, [setFocus])
