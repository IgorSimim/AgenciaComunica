      ...
      >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-4">
            ...
            <div className="sm:col-span-1">
              ...
              <input
                ...
                min="0"
                id="preco"
                className={`border rounded-md p-3 w-full focus:outline-none focus:ring-2 shadow-xs ${errors.preco ? 'border-red-500 focus:ring-red-400' : 'border-gray-300 focus:ring-yellow-400'
                  }`}
            ...
            <div className="sm:col-span-2">
              ...
              <textarea
                ...
                id="descricao"
                className={`border rounded-md p-3 w-full h-40 focus:outline-none focus:ring-2 shadow-xs ${errors.descricao ? 'border-red-500 focus:ring-red-400' : 'border-gray-300 focus:ring-yellow-400'
                  }`}
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mt-6 gap-4">
          <button
            type="submit"
            disabled={uploading}
            className="bg-yellow-400 text-black font-bold rounded-md py-4 px-8 w-full sm:w-auto cursor-pointer hover:bg-yellow-500 focus:outline-none focus:ring-4 focus:ring-yellow-300 transition-all duration-200 ease-in-out shadow-md disabled:opacity-50"
          >
            {uploading ? 'Enviando...' : 'Cadastrar serviço'}
          </button>
          <button
            type="button"
            className="bg-gray-500 text-white font-bold rounded-md py-4 px-8 w-full sm:w-auto cursor-pointer hover:bg-gray-600 focus:outline-none focus:ring-4 focus:ring-gray-300 transition-all duration-200 ease-in-out shadow-md"
            onClick={() => {
              reset()
              setSelectedFile(null)
              imageUploadRef.current?.clearImage()
