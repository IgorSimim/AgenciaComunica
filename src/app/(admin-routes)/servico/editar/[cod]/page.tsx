                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-4">
                        ...
                        <div className="sm:col-span-1">
                            ...
                            <input
                                ...
                                min="0"
                                id="preco"
                                className={`border rounded-md p-3 w-full focus:outline-hidden focus:ring-2 shadow-xs ${errors.preco ? 'border-red-500 focus:ring-red-400' : 'border-gray-300 focus:ring-yellow-400'
                                    }`}
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <textarea
                                ...
                                id="descricao"
                                className={`border rounded-md p-3 w-full h-40 focus:outline-hidden focus:ring-2 shadow-xs ${errors.descricao ? 'border-red-500 focus:ring-red-400' : 'border-gray-300 focus:ring-yellow-400'
                                    }`}
