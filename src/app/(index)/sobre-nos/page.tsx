    ...
    return (
        <div className="bg-black">
            ...
            <div className="py-12 text-center">
                <h2 className="text-white text-4xl font-semibold mb-12">Sobre nós</h2>
                ...
                <div className="mt-12 px-4">
                    <h3 className="text-white text-3xl font-semibold mb-6">Missão, Visão e Valores</h3>
                    <div className="flex flex-col md:flex-row justify-between gap-12">
                        ...
                        <div className="bg-yellow-300 p-8 rounded-xl shadow-lg w-full md:w-1/3 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                            <div className="flex justify-center mb-4">
                                <img src="/sobre-nos/icon-missao.png" alt="Icon missão" className="w-16 h-16" />
                            </div>
                            <h4 className="text-2xl font-semibold text-gray-800 mb-4">Missão</h4>
                        ...
                        <div className="bg-yellow-300 p-8 rounded-xl shadow-lg w-full md:w-1/3 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                            <div className="flex justify-center mb-4">
                                <img src="/sobre-nos/icon-visao.png" alt="Icon visão" className="w-16 h-16" />
                            </div>
                            <h4 className="text-2xl font-semibold text-gray-800 mb-4">Visão</h4>
                            <p className="text-lg font-medium text-gray-900">
                        ...
                        <div className="bg-yellow-300 p-8 rounded-xl shadow-lg w-full md:w-1/3 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                            <div className="flex justify-center mb-4">
                                <img src="/sobre-nos/icon-valores.png" alt="Icon valores" className="w-16 h-16" />
                            </div>
                            <h4 className="text-2xl font-semibold text-gray-800 mb-4">Valores</h4>
                            <p className="text-lg font-medium text-gray-900">
                                - Inovação<br />
                                - Transparência<br />
                                - Colaboração<br />
                ...
                <div className="mt-12">
                    <Link href="/contate-nos">
                        <button className="bg-orange-600 hover:bg-orange-700 text-white text-xl font-medium px-12 py-5 rounded-full transition-colors transform hover:scale-105 shadow-md">
                            Fale conosco
                        </button>
                    </Link>
                </div>
